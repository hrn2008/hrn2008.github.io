...
(function () {
    function Start() {
        ...
        $.getJSON("./Data/information.json", function (DataSource) {
            ...
            const linkHome = document.querySelector(".container .nav li:nth-child(1) a");
            linkHome.href = DataSource.NavLinks.Home;
            const linkAbout = document.querySelector(".container .nav li:nth-child(2) a");
            linkAbout.href = DataSource.NavLinks.About;
            const linkProject = document.querySelector(".container .nav li:nth-child(3) a");
            linkProject.href = DataSource.NavLinks.Projects;
            const linkService = document.querySelector(".container .nav li:nth-child(4) a");
            linkService.href = DataSource.NavLinks.Services;
            const linkContact = document.querySelector(".container .nav li:nth-child(5) a");
            ...
            switch (activePage) {
                ...
                case "/projects.html":
                    ...
                    const link1 = document.querySelector(".projects #project1 a");
                    const link2 = document.querySelector(".projects #project2 a");
                    const link3 = document.querySelector(".projects #project3 a");
